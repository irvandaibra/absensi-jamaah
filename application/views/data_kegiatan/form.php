...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('daftar_kegiatan/'.$this->uri->segment(2).$this->uri->segment(2) == 'ubah' && '/'.$this->uri->segment(3), 'class="mt-5 pt-5 pb-5 px-5"') ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <!-- <div class="col-md-12 mt-n2 mb-3">
                            <label for="nama" class="form-label">Code Unik</label>
                            <?php echo form_input('code_unik', $code_unik, 'class="form-control" id="code_unik"'); ?>
                        </div> -->
                        <div class="col-md-12 mt-n2 mb-3">
                            <label for="nama" class="form-label">Nama Kegiatan</label>
                            <?php echo form_input($nama_kegiatan, $nama_kegiatan['value'], 'class="form-control" id="nama" autocomplete="off" placeholder="Nama Kegiatan" required') ?>
                        </div>
                    </div>
                    <?php if($page === 'Ubah') { ?>
