...
<body>
        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper shadow-lg p-3 mb-4 rounded" style="height: 575px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page?> Penyesuaian</h2>
                        </div>
                    </div>
                    <?php if($page === 'Tambah') { ?>
                    <?php } else { ?>
                ...
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form <?php echo $page?> Penyesuain</h5>
                    </div>
                    <hr>
    ...
    $(document).ready(function() {
        $('#id_toko').change(function() {
            ...
            $.ajax({
                url: '<?= base_url(); ?>penyesuaian/get_produk_bytoko_id',
                method: 'POST',
                data: {
                    id_toko: id_toko
                },
    ...
    function pilihBarang(id) {
        if (id !== null) {
            $.ajax({
                url: '<?= base_url(); ?>penyesuaian/get_produk_byid/' + id,
                method: 'POST',
                data: {
                    id: id
                },
