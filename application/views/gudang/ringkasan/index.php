    ...
    <div class="all">
                ...
                <div class="shadow-lg p-2 rounded">
                    ...
                    <div class="container-fluid mt-4 w-100 ">
                        ...
                        <select class="form-select " disabled >
                                    <option selected>Pustaka</option>
                                    <option value="toko">Toko Solo</option>
                                    <option value="toko">Toko Jogja</option>
                                </select>
                        </div> -->
                            <!-- <div>
                        ...
                        <div class="scroll-table mt-3">
                            <table class="table table-hover table-secondary w-100">
                                <thead>
                                    <tr>
                                        <th class="">Nama Varian</th>
                                        <th class="">Kategori</th>
                                        <th class="">Stok Awal</th>
                                        <th class="">PO</th>
                                        <th class="">Terjual</th>
                                        <th class="">Tansfer</th>
                                        <th class="">Penyesuain</th>
                                        <th class="">Akhir</th>
                                    </tr>
                                </thead>
                            </table>
        ...
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                ajax: {
                    url: "<?= base_url('ringkasan/get_data/') ?>" + $('#toko').val(),
                    type: "POST"
                },
                deferRender: true,
                aLengthMenu: [
            ...
            $("#toko").on('change', function() {
                ...
                $('.table').DataTable({
                    ...
                    ajax: {
                        url: "<?= base_url('ringkasan/get_data/') ?>" + id,
                        type: "POST"
                    },
                    deferRender: true,
                    destroy: true,
