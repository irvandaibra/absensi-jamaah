                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Detail Transfer</h2>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="mt-4 px-2">
                                <div class="row px-2">
                                    <div class="mb-n1 col-6">
                                        <h5>Detail Permintaan Transfer</h5>
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-12 row">
                                        ...
                                        <div class="col-9">22 June 2023 12.01</div>
                                    </div>
                                    <div class="col-12 row mt-3">
                                        <div class="col-3">Asal Transfer</div>
                                        <div class="col-9">Tembalang - Bakpia&Bolu Tugu Jogja</div>
                                    </div>
                                    <div class="col-12 row mt-3">
                                        <div class="col-3">Tujuan Transfer</div>
                                        <div class="col-9">Ngaliyan - Bakpia&Bolu Tugu Jogja</div>
                                    </div>
                                    <div class="col-12 row mt-3">
                                        <div class="col-3">Nomer Pesanan</div>
                                        <div class="col-9">#b47dbc6b</div>
                                    </div>
                                    <hr class="mt-2">
                                    ...
                                    <ul class="ms-3">
                                        <li>12:01 <span class="ms-2 fw-bold">Doni Johanes</span> Memenuhi dan
                                            Menyelesaikan Semua Kiriman
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="d-flex justify-content-between ms-3">
                                                        <h6>Permintaan Transfer #b47dbc6b</h6>
                                                        <h6 class="text-end">22 June 2023 12.01</h6>
                                                    </div>
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
