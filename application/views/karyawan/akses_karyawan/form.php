...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('role_karyawan/'.$this->uri->segment(2).$this->uri->segment(2) == 'ubah' && '/'.$this->uri->segment(3), 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 280px; background-color: white;">
            <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page?> Akses Karyawan</h2>
                        </div>
                    </div>
                    <?php if($page === 'Tambah') { ?>
                    <?php } else { ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <label for="nama_role" class="form-label">Nama Role</label>
                                <?php echo form_input($nama_role, '', 'class="form-control w-100" id="nama_role" autocomplete="off" placeholder="Nama Role" required') ?>
                        </div>
                    </div>
                    <?php if($page === 'Ubah') { ?>
                        <button class="btn btn-danger float-start" type="button" onClick="location.href='<?php echo base_url('akses_karyawan/hapus/'.$row['id'])?>'">
                            Hapus
                        </button>
                    <?php } else { ?>
                    <?php } ?>
