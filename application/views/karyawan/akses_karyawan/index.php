                    ...
                    <div class="page-breadcrumb">
                        <div class="row">
                            <div class="col-4 align-self-center">
                                <h2 class="page-title">Akses Karyawan</h2>
                            </div>
                            <div class="col-8 row d-flex justify-content-end">
                                <div class="col-4">
                                    <a href="<?php echo base_url('akses_karyawan/tambah')?>"
...
$(document).ready(function() {
    tabel = $('.table').DataTable({
        ...
        ajax: {
            "url": "<?= base_url('akses_karyawan/get_data');?>",
            "type": "POST"
        },
        deferRender: true,
        aLengthMenu: [
        ...
        columns: [{
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return '<a href="<?php echo base_url('akses_karyawan/ubah/')?>' + data +
