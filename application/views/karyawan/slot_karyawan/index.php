                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Slot Karyawan</h2>
                        </div>
                        <div class="col-6 row justify-content-end">
                            <div class="col-4 mx-n1">
                                <a href="<?php echo base_url('slot_karyawan/export')?>" class="btn btn-primary w-100">
                                    Export
                                </a>
                            </div>
                            <div class="col-4 mx-n1">
                                <a href="<?php echo base_url('slot_karyawan/tambah')?>" class="btn btn-primary w-100">
                                    Tambah Slot
                                </a>
                            </div>
                        </div>
...
$(document).ready(function() {
    tabel = $('.table').DataTable({
        ...
        ajax: {
            "url": "<?= base_url('slot_karyawan/get_data/');?>" + $('#toko').val(),
            "type": "POST"
        },
        deferRender: true,
        aLengthMenu: [
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return '<a href="<?php echo base_url('slot_karyawan/ubah/')?>' + data +
    ...
    $("#toko").on('change', function() {
        ...
        $('.table').DataTable({
            ...
            ajax: {
                url: "<?= base_url('slot_karyawan/get_data/') ?>" + id,
                type: "POST"
            },
            deferRender: true,
            destroy: true,
            ...
            columns: [
                ...
                },
                {
                    data: "id",
                    "render": function(data, type, row, meta) {
                        return '<a href="<?php echo base_url('slot_karyawan/ubah/')?>' +
                            data +
                            '" class="btn btn-sm btn-primary">Ubah</a>';
                    }
                },
