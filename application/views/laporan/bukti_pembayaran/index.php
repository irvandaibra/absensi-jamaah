                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Bukti Pembayaran</h2>
                        </div>
                        <div class="col-6 ">
                            <div class="btn-group float-end w-25">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Detail Item</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-secondary w-100">
                            ...
                            <!-- <tbody>
                                <tr class="table-light">
                                    ...
                                    <td class="text-end">
                                        <a href="<?php echo base_url('bukti_pembayaran/detail')?>"
    ...
    <script>
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                ajax:
                {
                    url: "<?= base_url('bukti_pembayaran/get_data/') ?>" + $('#toko').val(),
                    type: "POST"
                },
                deferRender: true,
            ...
            $("#toko").on('change', function() {
                ...
                $('.table').DataTable({
                    ...
                    ajax:
                    {
                        url: "<?= base_url('bukti_pembayaran/get_data/') ?>" + id,
                        type: "POST"
                    },
                    deferRender: true,
                    destroy: true,
