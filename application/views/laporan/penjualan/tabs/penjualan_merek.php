    ...
    <table class="table table-penjualan">
        <thead class="table-light">
            <tr>
                ...
                <th class="text-end text-truncate">Gratifikasi Dikumpulkan</th>
                <th class="text-end text-truncate">Pajak Dikumpulkan</th>
        ...
        <tbody>
            <tr>
                <td class="text-start p-2 text-truncate fw-medium border-end">Unbranded</td>
                ...
                <td class="text-end p-2 text-truncate">Rp. 0</td>
                <td class="text-end p-2 text-truncate">Rp. 109.000</td>
                <td class="text-end p-2 text-truncat">Rp. 0</td>
                <td class="text-end p-2 text-truncat">Rp. 0</td>
            ...
            <tr>
                <td class="text-start px-3 py-2 text-truncate fw-medium border-end">BKJ Reguler</td>
                <td class="text-end p-2 text-truncate">3</td>
                <td class="text-end p-2 text-truncate">0</td>
                <td class="text-end p-2 text-truncate">Rp. 109.000</td>
                <td class="text-end p-2 text-truncate">Rp. 0</td>
            ...
            <tr>
                <td class="text-start px-3 py-2 text-truncate fw-medium border-end">BKTJ Travel Pack</td>
