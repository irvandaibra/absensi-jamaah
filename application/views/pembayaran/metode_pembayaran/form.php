...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('metode_pembayaran/'.$this->uri->segment(2).$this->uri->segment(2) == 'ubah' && '/'.$this->uri->segment(3), 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 100%; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page?> Metode Pembayaran</h2>
                        </div>
                    </div>
                    <?php if($page === 'Tambah') { ?>
                    <?php } else { ?>
                ...
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form <?php echo $page?> Metode Pembayaran</h5>
                    </div>
                    <hr>
                    <div class="row">
                            <div class="mt-1 mb-3">
                                <label for="nama" class="form-label">Nama Pembayaran</label>
                                <?php echo form_input($nama_pembayaran, '', 'class="form-control w-100" id="nama" autocomplete="off" placeholder="Nama pembayaran" required') ?>
                            </div>
                        </div>
                        <?php if($page === 'Ubah') { ?>
                        <div class="mx-2">
                            <button class="btn btn-danger float-start" type="button" onClick="location.href='<?php echo base_url('metode_pembayaran/hapus/'.$row['id'])?>'">
                                Hapus
                            </button>
                        </div>
                        <?php } else { ?>
