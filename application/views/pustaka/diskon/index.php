                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Diskon</h2>
                        </div>
                        <div class="col-6 row justify-content-end">
                            <div class="col-4 mx-n1">
                                <a href="<?php echo base_url('diskon/tambah')?>" class="btn btn-primary w-100">Tambah
                                    Diskon</a>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                ajax:
                {
                    url: "<?= base_url('diskon/get_data/') ?>" + $('#toko').val(),
                    type: "POST"
                },
                deferRender: true,
                ...
                columnDefs: [
                    ...
                    },
                    {
                        targets: 4,
                        render: function (data, type, row, meta) {
                            return `<a href="<?php echo base_url('diskon/ubah/')?>${data}" class="btn btn-sm btn-primary">Ubah</a>`;
                        }
                    }
                ],
            });
            $("#toko").on('change', function() {
                ...
                $('.table').DataTable({
                    ...
                    ajax:
                    {
                        url: "<?= base_url('diskon/get_data/') ?>" + id,
                        type: "POST"
                    },
                    deferRender: true,
                    destroy: true,
