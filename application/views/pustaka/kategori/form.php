...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('kategori/'.$this->uri->segment(2).$this->uri->segment(2) == 'ubah' && '/'.$this->uri->segment(3), 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 300px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page?> Kategori</h2>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form <?php echo $page?> Kategori</h5>
                    </div>
                    <hr>
                    <div class="input-group mt-n2 mb-3">
                        <?php echo form_input($nama_kategori, $nama_kategori['value'], 'class="form-control" autocomplete="off" placeholder="Nama Kategori" required') ?>
                    </div>
                    <?php if($page === 'Ubah') { ?>
                    <button type="button" onClick="location.href='<?php echo base_url('kategori/hapus/'.$row['id'])?>'"
                    ...
                    <button type="button" class="btn btn-outline-secondary float-end mx-1"
                        onClick="location.href='<?php echo base_url('kategori')?>'">Batal</button>
                </div>
            </div>
            <?php echo form_close(); ?>
        </div>
