                    ...
                    <div class="row">
                        ...
                        <div class="col-6 row justify-content-end">
                            <div class="col-4 mx-n1">
                                <a href="<?php echo base_url('kategori/tambah')?>" class="btn btn-primary w-100">Tambah
                                    Kategori</a>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                ajax:
                {
                    url: "<?= base_url('kategori/get_data/')?>" + $('#toko').val(),
                    type: "POST"
                },
                deferRender: true,
                destroy: true,
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            <a href="<?php echo base_url('kategori/ubah/')?>${data}" class="btn btn-sm btn-primary">Ubah</a>
                            </div>`
                        }
                    }
                ],
