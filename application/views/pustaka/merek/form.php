...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('merek/'.$this->uri->segment(2).$this->uri->segment(2) == 'ubah' && '/'.$this->uri->segment(3),  'class="mt-5 pt-5 pb-5 px-5 "') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 330px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page?> Merek</h2>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form <?php echo $page?> Merek</h5>
                    </div>
                    <hr>
                    <div class="mt-4 px-2">
                        <div class="mt-n2 mb-3">
                            <label for="nama" class="form-label">Nama Merek</label>
                            <?php echo form_input($nama_merek, $nama_merek['value'], 'class="form-control" autocomplete="off" placeholder="Nama Merek" required') ?>
                        </div>
                        <?php if ($page === 'Ubah') { ?>
                        <button type="button" onClick="location.href='<?php echo base_url('merek/hapus/'.$row['id'])?>'"
                        ...
                        <button type="submit" name="submit_type" value="spesific_o"
                            class="btn btn-primary float-end"><?php echo $page ?></button>
