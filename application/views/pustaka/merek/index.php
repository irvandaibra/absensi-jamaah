                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Merek</h2>
                        </div>
                        <div class="col-6 row justify-content-end">
                            <div class="col-4 mx-n1">
                                <a href="<?php echo base_url('merek/tambah')?>" class="btn btn-primary">Tambah Merek</a>
                            </div>
                        </div>
                    ...
                    <div class="scroll-table">
                        <table class="table table-hover table-secondary ">
                            <thead>
                                <tr>
                                    <th>Nama Merek</th>
                                    <th class="text-center">Item Stok</th>
    ...
    <script>
        $(document).ready(function() {
            $('.table').DataTable({
                ...
                order: [[0, 'asc']],
                ajax: {
                    url: "<?= base_url('merek/get_data/') ?>" + $('#toko').val(),
                    type: "POST"
                },
                deferRender: true,
                aLengthMenu: [
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function (data, type, row, meta) {
                            return `<a href="<?php echo base_url('merek/ubah/')?>${data}" class="btn btn-sm btn-primary">Ubah</a>`;
                        }
                    },
                ]
            });
            $("#toko").on('change', function() {
                ...
                $('.table').DataTable({
                    ...
                    order: [[0, 'asc']],
                    ajax: {
                        url: "<?= base_url('merek/get_data/') ?>" + id,
                        type: "POST"
                    },
                    deferRender: true,
                    destroy: true,
