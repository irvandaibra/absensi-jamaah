...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart(base_url('akun/ubah_detail_personal'), 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 350px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Ubah Detail Personal</h2>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form Detail Personal</h5>
                    </div>
                    <hr>
                    <div class="mt-4 px-2">
                        <div class="row">
                            <div class="col-6 mt-n2 mb-3">
                                ...
                                <?php echo form_input($username, $username['value'], 'class="form-control" autocomplete="off" placeholder="Nama" required') ?>
                            </div>
                            <div class="col-6 mt-n2 mb-3">
                            ...
                            <div class="col-12 mt-n2 mb-3">
                                ...
                                <?php echo form_input($email, $email['value'], 'class="form-control" autocomplete="off" placeholder="Email" disabled') ?>
                            </div>
                        </div>
