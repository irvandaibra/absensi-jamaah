...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart('akun/ubah_info_bisnis', 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 430px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title">Ubah Bisnis Info</h2>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form Bisnis Info</h5>
                    </div>
                    <hr>
                    <div class="mt-4 px-2">
                        <div class="row">
                            <div class="col-6 mt-n2 mb-3">
                                <label for="nama_binis" class="form-label">Nama Bisnis</label>
                                <?php echo form_input($nama_bisnis, $nama_bisnis['value'], 'class="form-control" id="nama" autocomplete="off" placeholder="Nama Bisnis" required') ?>
                            </div>
                            <div class="col-6 mt-n2 mb-3">
                                <label for="alamat_binis" class="form-label">Alamat Bisnis</label>
                                <?php echo form_input($alamat_bisnis, $alamat_bisnis['value'], 'class="form-control" id="alamat" autocomplete="off" placeholder="Alamat Bisnis" required') ?>
                            </div>
                            <div class="col-md-4 mt-n2 mb-3">
                                <label for="provinsi" class="form-label">Provinsi</label>
                                <select name="provinsi" id="provinsi" class="form-select select2 border-danger">
                                    <option default value="<?php echo $value_provinsi ?>"><?php echo $value_provinsi ?>
                                    </option>
                                    <?php
                            ...
                            <div class="col-md-4 mt-n2 mb-3">
                                ...
                                <select name="kota" id="kabupaten" class="form-select select2 border-danger">
                                    <option default value="<?php echo $value_kota ?>"><?php echo $value_kota ?>
                                        <?php
                            ...
                            <div class="col-md-4 mt-n2 mb-3">
                                ...
                                <select name="kecamatan" id="kecamatan" class="form-select select2 border-danger">
                                    <option default value="<?php echo $value_kecamatan ?>">
                                        <?php echo $value_kecamatan ?>
                                        <?php
                            ...
                            <div class="col-md-6 mt-n2 mb-3">
                                ...
                                <select name="desa" id="desa" class="form-select select2 border-danger">
                                    <option default value="<?php echo $value_desa ?>"><?php echo $value_desa ?>
                                        <?php
