...
<body>
    <div class="all">
        ...
        <div id="main-wrapper">
            ...
            <?php echo form_open_multipart(base_url('akun/asdasdsad'), 'class="mt-5 pt-5 pb-5 px-5"') ?>
            <div class="page-wrapper shadow-lg p-3 mb-5 rounded" style="height: 350px; background-color: white;">
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-6 align-self-center">
                            <h2 class="page-title"><?php echo $page ?> Akun Kasir</h2>
                        </div>
                    </div>
                </div>
                <div class="container-fluid">
                    <div class="mb-n3">
                        <h5>Form Akun Kasir</h5>
                    </div>
                    <hr>
                    <div class="mt-4 px-2">
                        <div class="row">
                            <div class="col-6 mt-n2 mb-3">
                                ...
                                <?php echo form_input('', '', 'class="form-control" autocomplete="off" placeholder="Nama Depan" required') ?>
                            </div>
                            <div class="col-6 mt-n2 mb-3">
                                <label for="namadepan" class="form-label">Nama Belakang</label>
                                <?php echo form_input('', '', 'class="form-control" autocomplete="off" placeholder="Nama Belakang" required') ?>
                            </div>
                            <div class="col-6 mt-n2 mb-3">
                                <label for="email" class="form-label">Email</label>
                                <?php echo form_input('', '', 'class="form-control" autocomplete="off" placeholder="Email" required') ?>
                            </div>
                            <div class="col-6 mt-n2 mb-3">
                                <label for="telepon" class="form-label">Nomor Telepon</label>
                                <?php echo form_input('', '', 'class="form-control" autocomplete="off" placeholder="No Telepon" required') ?>
                            </div>
                        </div>
                        <?php if($page === 'Ubah') { ?>
                        <button type="button" onClick="location.href='<?php echo base_url('akun/hapus/asdsadasd')?>'"
