            ...
            <div class="shadow-lg p-2 rounded">
                        ...
                        <div class="col-8 row d-flex justify-content-end">
                            <div class="col-4 d-flex justify-content-end">
                                <button type="submit" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">Catatan Aktivitas</button>
                            </div>
                            <div class="col-4 d-flex justify-content-end">
                                <a href="<?php echo base_url('akun_bank/tambah')?>" class="btn btn-primary">Tambah Akun
                                    Bank</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid mt-4">
                    <div class="scroll-table">
                        <table class="table table-hover table-secondary w-100" id="table_data">
                            <thead>
                                <tr>
                                    <th>Nama Akun Bank</th>
                                    <th class="text-center">Nomor Akun</th>
                                    <th class="text-center">Nama Pemegang Akun</th>
                                    ...
                                    <div class="modal-body">
                                        <table class="table table-hover table-secondary w-100">
                                            <thead>
                                                <tr>
                                                    <th>Waktu</th>
                                                    <th class="text-center">Di Update Oleh</th>
                                                ...
                                                <?php foreach($data_log as $log): ?>
                                                    <tr class="table-light">
                                                        ...
                                                        <td class="text-center">
                                                            <div>
                                                                <?php echo Akun($log->id_akun, 'username') ?>
                                                            </div>
                                                            <div>
                                                                <?php echo Akun($log->id_akun, 'email') ?>
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <div>
                                                                <?php echo $log->nama_bank ?>
                                                            </div>
                                                            <div>
                                                                <?php echo $log->nomor_akun ?>
                                                            </div>
                                                        </td>
                                                        <td class="text-center 
                                                            <?php if ($log->aksi == 'Menambahkan Bank') {
                                                                echo 'text-success';
                                                             } else if ($log->aksi == 'Mengubah Bank') {
                                                                echo 'text-primary';
                                                             } else if ($log->aksi == 'Menghapus Bank') {
                                                                echo 'text-danger';
                                                             } ?>">
                                                            <?php echo $log->aksi ?>
                                                        </td>
    ...
    <script>
        $(document).ready(function() {
            $('#table_data').DataTable({
                ...
                order: [[0, 'asc']],
                ajax: {
                    url: "<?= base_url('akun_bank/get_data') ?>",
                    type: "POST"
                },
                deferRender: true,
                aLengthMenu: [
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `<a href="<?php echo base_url('akun_bank/ubah/')?>${data}" class="btn btn-sm btn-primary">Ubah</a>`;
                        }
                    },
                ]
            });
