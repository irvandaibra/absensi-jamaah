                    ...
                    <div class="row">
                        ...
                        <div class="col-6 row justify-content-end">
                            <div class="col-4 mx-n1 d-flex justify-content-end">
                                <button type="button" class="btn btn-outline-secondary">Total : <?php echo $totaldata?></button>
                            </div>
                            <div class="col-4 mx-n1">
                                <a class="btn btn-primary w-100"
                                    href="<?php echo base_url('toko/tambah')?>">Tambah Toko</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                columnDefs: [
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `<a href="<?php echo base_url('toko/ubah/')?>${data}" class="btn btn-sm btn-primary w-100">Ubah Toko</a>`;
                        }
                    },
                ]
            });
