                ...
                <div style="background-color: #ffff;">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                                <div>
                                    <h2 class="card-title mb-0">Daftar Saran Tanggapan</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <h5 class="card-subtitle">
                               Dalam page ini Akan menampilkan data-data Saran / Masukan dari user
                            </h5>
                        </div>
                    </div>
...
$(document).ready(function() {
    tabel = $('.table').DataTable({
        ...
        ajax: {
            "url": "<?= base_url('tanggapan/get_data');?>",
            "type": "POST"
        },
        deferRender: true,
        aLengthMenu: [
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return '<a href="<?php echo base_url('tanggapan/respon/')?>' + data +
